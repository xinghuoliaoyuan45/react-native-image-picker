...
import com.maxiaoyao.imagepicker.base.activity.ImagePickerBaseActivity;
...
import com.maxiaoyao.imagepicker.ui.crop.ImageCropActivity;
import com.maxiaoyao.imagepicker.ui.grid.adapter.ImageDataAdapter;
import com.maxiaoyao.imagepicker.ui.grid.presenter.ImageDataPresenter;
import com.maxiaoyao.imagepicker.ui.pager.view.ImagePagerActivity;
import com.maxiaoyao.imagepicker.utils.ImagePickerComUtils;
import com.maxiaoyao.imagepicker.utils.PermissionChecker;
import com.maxiaoyao.imagepicker.utils.TakePhotoCompatUtils;
import com.maxiaoyao.imagepicker.widget.ImagePickerActionBar;

import java.util.ArrayList;
import java.util.List;

import static com.maxiaoyao.imagepicker.data.ImageContants.REQUEST_CODE_PERMISSION_CAMERA;
import static com.maxiaoyao.imagepicker.data.ImageContants.REQUEST_CODE_PERMISSION_SDCARD;
import static com.maxiaoyao.imagepicker.utils.PermissionChecker.checkPermissions;
        ...
        , ImageFloderPop.onFloderItemClickListener, AbsListView.OnScrollListener
{
    ...
    private void returnSingleImage(ImageBean imageBean)
    {
        ...
        Log.e("returnmethod","returnSingleImage");
        finish();
    }
    ...
    private void returnAllSelectedImages()
    {
        ...
        Log.e("returnmethod","returnAllSelectedImages");
        Intent intent = new Intent();
